...
| Week | Date | Topic | Slides | Reading |
|---|---|---|---|---|
| 6 | Oct 8 | **Field trip: Montpelier — NBRC stakeholder meeting** *(no in-class instruction)* | — | — |
...
::: {.callout-note appearance="minimal"}
Quarto as a one-stop communication tool. Packages: `quarto`, `rmarkdown`
:::
...
| 16 | Dec 17 | **Final presentations in Montpelier** *(in-person, at NBRC or nearby)* |
